...
Scramble Proに課金する必要があるが、かなり有用なライブラリのため、組み合わせると超強いかも。
laravel-dataでRequestやResourceに型付けをできるため、シンプルな実装で型付けをしつつ、ドキュメントも自動化って夢があるなおい！

[![Image from Gyazo](https://i.gyazo.com/11ca38391af6655ac427079211a8002d.png)](https://gyazo.com/11ca38391af6655ac427079211a8002d)

料金はこんな感じ。
興味がある人は[公式](https://scramble.dedoc.co/usage/laravel-data)見てみるといいかも。
